		...
		<div class="container">
			<div class="row">
				<div class="col-lg-9 col-md-8">
					<h1 class="font-weight-bold mb-0">Consultas ubicaciones</h1>
					<p>Pagina de consultas de prestamos por ubicacion</p>
				</div>
			</div>
		</div>
	</section>
...
?>
<script type=" text/javascript" src="scripts/consultaubicaciones.js">
</script>
<?php
}
ob_end_flush();
