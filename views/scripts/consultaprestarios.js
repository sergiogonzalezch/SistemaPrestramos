/*Crear variable tabla para realizar
el procedimiento de enlistar los registros*/
var tabla;
//Init
//Función que se ejecuta al inicio
function init() {
	/*Llamar a la función listar se ejecuta al inicio para visualizar todos los registros en una tabla de datatables*/
	listar();
...
function listar() {
	...
	tabla = $('#tbllistado').dataTable({
		...
		"ajax": {
			...
			url: '../ajax/consulta.php?op=consultaPrestarios',
			//Enviar los parámetros para establecer el rango de fechas
			data: {
				fechaInicio: fechaInicio,
				fechaFin: fechaFin
			},
			type: "get", //Indicar el tipo de operación para obtener los datos
