...
// Client address
function addValuesDates( $folio,$matricula,$nombre,$primerap,$segundoap,$edificio,$tipoarea,$area,$status,$cierre,$total )
{
	$r1     = $this->w - 200;
	$r2     = $r1 +40;
	$y1     = 40;
	$this->SetXY( $r1, $y1);
	$this->SetFont( "Arial", "B", 10);
	$this->MultiCell( 60, 4, "Datos");
	$this->SetXY( $r1, $y1+5);
	$this->SetFont( "Arial", "", 10);
	$this->MultiCell( 150, 1, $folio);
	$this->SetXY( $r1, $y1+10);
	$this->MultiCell( 150, 2, $matricula);

	$this->SetXY( $r1, $y1+15);
	$this->MultiCell( 150, 3, $nombre);
	$this->SetXY( $r2, $y1+15);
	$this->MultiCell( 150, 3, $primerap);
	$this->SetXY( $r2+15, $y1+15);
	$this->MultiCell( 150, 3, $segundoap);

	$this->SetXY( $r1, $y1+20);
	$this->MultiCell( 150, 4, $edificio);
	$this->SetXY( $r2-20, $y1+20);
	$this->MultiCell( 150, 4, $tipoarea);
	$this->SetXY( $r2+15, $y1+20);
	$this->MultiCell( 150, 4, $area);


	$this->SetXY( $r1, $y1+25);
	$this->MultiCell( 150, 5, $status);
	$this->SetXY( $r2-10, $y1+25);
	$this->MultiCell( 150, 5, $cierre);
	$this->SetXY( $r1, $y1+30);
	$this->MultiCell( 150, 6, $total);
}
