...
function init() {
	/*Llamar a la función listar se ejecuta al inicio para v
	isualizar todos los registros en una tabla de datatables*/
	listar();
...
function listar() {
	...
	tabla = $('#tbllistado').dataTable({
		...
		"ajax": {
			...
			url: '../ajax/consulta.php?op=consultaDevolucion',
